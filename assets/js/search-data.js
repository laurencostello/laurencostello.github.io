...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=iztY4zEAAAAJ", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/laurencostello.bsky.social", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.goodreads.com/user/show/136318702-lauren-costello", "_blank");
        },
      },{
      id: 'light-theme',
